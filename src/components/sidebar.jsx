    ...
    <div className="sidebar">
      ...
      <ul className="sidebar-list">
        <li className="sidebar-list-item">
          <a href="#" onClick={() => handleItemClick('Universities')}>
        ...
        <li className="sidebar-list-item">
          <a href="#" onClick={() => handleItemClick('Rate and Review')}>
        ...
        <li className="sidebar-list-item">
          <a href="#" onClick={() => handleItemClick('Compare')}>
        ...
        <li className="sidebar-list-item">
          <a href="#" onClick={() => handleItemClick('About Us')}>
      ...
      <div className="account-info">
        ...
        <button className="account-info-more"  onClick={() => handleItemClick('Profile')}>
